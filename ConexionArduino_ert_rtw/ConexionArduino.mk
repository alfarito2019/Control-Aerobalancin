###########################################################################
## Makefile generated for component 'ConexionArduino'. 
## 
## Makefile     : ConexionArduino.mk
## Generated on : Tue Aug 20 08:27:31 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ConexionArduino.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ConexionArduino.elf
...
DEFINES_STANDARD = -DMODEL=ConexionArduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o ConexionArduino.o ConexionArduino_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ConexionArduino_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/ConexionArduino_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/ConexionArduino_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
ConexionArduino.o : $(START_DIR)/ConexionArduino_ert_rtw/ConexionArduino.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ConexionArduino_data.o : $(START_DIR)/ConexionArduino_ert_rtw/ConexionArduino_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/ConexionArduino_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
