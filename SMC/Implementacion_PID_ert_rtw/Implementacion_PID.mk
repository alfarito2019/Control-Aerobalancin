...
## Generated on : Tue Sep 03 20:26:48 2024
...
PRODUCT_NAME              = Implementacion_PID
MAKEFILE                  = Implementacion_PID.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Implementacion_PID.elf
...
DEFINES_STANDARD = -DMODEL=Implementacion_PID -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o Implementacion_PID.o Implementacion_PID_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Implementacion_PID_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/Implementacion_PID_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/Implementacion_PID_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
Implementacion_PID.o : $(START_DIR)/Implementacion_PID_ert_rtw/Implementacion_PID.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


Implementacion_PID_data.o : $(START_DIR)/Implementacion_PID_ert_rtw/Implementacion_PID_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/Implementacion_PID_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
